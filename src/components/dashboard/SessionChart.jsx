...
export const SessionsChart = () => (
  <div style={{ backgroundColor: "var(--secondary-colorscolor-1)", borderRadius: 12, padding: 28 }}>
    <div style={{ display: "flex", alignItems: "center", gap: "6px", marginBottom: "8px" }}>
      <img src="https://c.animaapp.com/mb540qadkyydE0/img/custome-icon-sessions-icon.svg" alt="Sessions Icon" style={{ width: "12px", height: "12px" }} />
    ...
    <ResponsiveContainer width="100%" height={100}>
      <LineChart data={data}>
        ...
        <Line type="monotone" dataKey="sessions" stroke="#c85ffc" strokeWidth={3} dot={{ r: 5 }} />
      </LineChart>
    </ResponsiveContainer>
